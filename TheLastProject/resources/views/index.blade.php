        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="/login">EMPIEZA</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="about-us" id="about">
        <div class="container">
            <div class="text-center">
                ...
                <p>
                    Somos expertos en la creación de páginas web impactantes y sistemas de gestión empresarial
                    personalizados.
                    Nos dedicamos a impulsar el éxito empresarial a través de soluciones digitales y Nos apasiona
                    colaborar
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        ...
                        <p class="text-muted mb-0">Creamos tu pagina web enfocada en la venta de uno o varios productos
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        ...
                        <p class="text-muted mb-0">Creamos tu sistema de gestion empresarial para la administracion de
                            la empresa</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        ...
                        <p class="text-muted mb-0">Siempre estaremos a disposicion del cliente bajo cualquier duda o
                            consulta</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5">
                        <img class="img-fluid rounded-circle" src="{{ asset('images/portfolio/p-1.jpeg') }}"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
                        ...
                        <p>
                            El proyecto se empezo a desarrollar el 25 de diciembre de 2023 y salio a la luz en marzo de
                            2024
    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="p-5">
                        <img class="img-fluid rounded-circle" src="{{ asset('images/portfolio/p-2.jpeg') }}"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <p>
                            Tenemos pensado programar y entrenar una IA para la creacion y personalizacion de paginas
                            web
                            para finales de 2025 de esta forma conseguiremos mejorar la calidad de nuestro trabajo
                            ademas
    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5">
                        <img class="img-fluid rounded-circle" src="{{ asset('images/portfolio/p-3.jpeg') }}"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
                        ...
                        <p>
                            "Acabamos de empezar" y a partir de 2025 vamos a seguir mejorandonos y superandonos para
                            ofrecer
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <div class="line-shape"></div>
                    <p>
                        Si tienes cualquier duda estamos a tu disposicion, trataremos de responderte lo antes posible
                        pero
                ...
                <div class="row">
                    <div class="col-md-12 form-line">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nombre" id="exampleInputUsername"
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" name="telefono" id="telephone"
            ...
            <ul class="list-inline mb-5">
                <li class="list-inline-item">
                    <a class="social-link rounded-circle text-white"
                        href="https://github.com/AntonioMartinSosa/ProyectoPFC">
